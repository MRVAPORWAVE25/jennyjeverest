...
/** @type {string} */
const CACHE_VERSION = '1776548494|1642386940';
/** @type {string} */
const CACHE_PREFIX = 'JENNY-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'JENNY.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["JENNY.html","JENNY.js","JENNY.offline.html","JENNY.icon.png","JENNY.apple-touch-icon.png","JENNY.audio.worklet.js","JENNY.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["JENNY.wasm","JENNY.pck"];
